...
bot.on("ready", () => {
    bot.user.setActivity('with Music', { type: 'PLAYING' }) //Sets the bots' game or whatever status message you want
...
bot.on("guildMemberAdd", async member =>{ //Welcoming the user to the server, sending them a PM with rules and such, then giving them the member role
    ...
    welcomeChannel.send("Your friend, Descend.");
